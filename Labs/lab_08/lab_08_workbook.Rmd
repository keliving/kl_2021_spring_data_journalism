...
# The column names are long and confusing and some of the rows are missing data. 
...
embed_youtube("gD687oB8jiU", width = 600, height=480, frameborder = 0,
...
The data set we read in had two very unwieldy column names. 
...
# Video B 
# Click play to run the codeblock and the video will display in the markdown document. 
embed_youtube("ZC67K4LLGDY", width = 600, height=400, frameborder = 0,
allowfullscreen = FALSE, query = NULL)
...
# Video C 
# Click play to run the codeblock and the video will display in the markdown document. 
embed_youtube("x4r_Nq0RKkk", width = 600, height= 400, frameborder = 0,
allowfullscreen = FALSE, query = NULL)
...
# Video D
# Click play to run the codeblock and the video will display in the markdown document. 
embed_youtube("E3NUaUY5y5s", width = 600, height=400, frameborder = 0,
allowfullscreen = FALSE, query = NULL)
...
# Video E 
# Click play to run the codeblock and the video will display in the markdown document. 
embed_youtube("bm9PqSARhcs", width = 600, height=480, frameborder = 0,
allowfullscreen = FALSE, query = NULL)
