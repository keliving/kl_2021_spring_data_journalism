...
embed_youtube("uZXIPLQ7wb4", width = 500, height=480, frameborder = 0,
...
# Put the answer here
# Norton City, Virginia had the most pills per person with 305.67 or about 306 pills. 
...
# Video b
# Click play to run the codeblock and the video will display in the markdown document. 
embed_youtube("vk9N4jkZRQM", width = 500, height=480, frameborder = 0,
allowfullscreen = FALSE, query = NULL)
...
# Video c
# Click play to run the codeblock and the video will display in the markdown document. 
embed_youtube("YjcgraKC8Ik", width = 500, height=480, frameborder = 0,
allowfullscreen = FALSE, query = NULL)
...
# Video d
# Click play to run the codeblock and the video will display in the markdown document. 
embed_youtube("X3iEjssEBys", width = 500, height=480, frameborder = 0,
allowfullscreen = FALSE, query = NULL)
...
# Video d
# Click play to run the codeblock and the video will display in the markdown document. 
embed_youtube("Yg-pNqzDuN4", width = 500, height=400, frameborder = 0,
allowfullscreen = FALSE, query = NULL)
