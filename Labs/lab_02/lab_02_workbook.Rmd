...
glimpse("arcos_md_baltimore_city")
...
```{r}
# Answer to question 1: Giant Pharmacy 166

arcos_md_baltimorecity_sorted_task <- arcos_md_baltimorecity_trimmed %>%
...
```{r}
# Answer to question 2: Dr. Alan E. Oshinsky (4 pills) and Dr. Julian Jakobovits (4 pills)

arcos_md_baltimorecity_sorted_task_2 <- arcos_md_baltimorecity_trimmed %>%
  arrange(total_dosage_unit)
