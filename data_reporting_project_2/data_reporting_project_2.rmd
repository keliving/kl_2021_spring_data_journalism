...
## Ask team about error with the chunk of code run above ^
...
* **Sentence text**: Are lottery ticket retail outlets concentrated (total number of retailers or retailers per person) in low-income areas or non-white areas? (easier)
