...
# A: Delaware, Maryland and Virginia are returned by the inner join. 
```
...
# Q: which states are returned by this join?
# A: Delaware, Maryland and Virginia are returned with population values. 
```
### Right Join
...
# Q: which states are returned by this join?
# A: Delaware, Maryland, Virginia and Pennsylvania are returned by this join. 
```
...
# Q: which states are returned by this join?
# A: Pennsylvania, Virginia, Maryland and Delaware are returned by this join.  
```
## New Joins
...
# Q: which states are returned by this join?
# A: Delaware, D.C., Maryland, Virginia and Pennsylvania are returned by this join. 
```
...
# Q: which states are returned by this join?
# A: D.C. is returned by this join. 
```
...
# Q: which states are returned by this join?
# A: Pennsylvania is returned by this join. 
```
