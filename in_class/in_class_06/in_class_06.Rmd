...
covid_cases_per_1000 <- state_covid_population %>%
  mutate(cases_per_1000 = (total_cases/population)*1000) %>%
  arrange(desc(cases_per_1000))

# Answer: Louisiana had the highest number of COVID cases per 1,000 people on August 30, 2020. 

```

```{r}

covid_deaths_per_1000 <- state_covid_population %>%
  mutate(deaths_per_1000 = (total_deaths/population)*1000) %>% 
  arrange(deaths_per_1000) 

#Answer: Hawaii had the lowest number of COVID deaths per 1,000 people on August 30, 2020. 
